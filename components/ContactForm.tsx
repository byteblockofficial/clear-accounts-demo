...
export default function ContactForm() {
  ...
  if (status === "success") return (
    <div role="alert" className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-8 text-center">
      ...
      <p className="font-semibold text-[var(--color-primary)] mb-1">Enquiry sent!</p>
      <p className="text-sm text-[var(--color-text-muted)]">We&apos;ll be in touch shortly. Or call <a href="tel:01610000006" className="underline">0161 000 0006</a>.</p>
    </div>
  );

  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-4">
      {status === "error" && <div role="alert" className="bg-red-50 border border-red-200 text-red-800 text-sm px-4 py-3 rounded-md">Something went wrong. Please call <a href="tel:01610000006" className="underline">0161 000 0006</a>.</div>}
      <div>
      ...
      <div>
        <label htmlFor="message" className="block text-sm font-medium text-[var(--color-text)] mb-1">Tell us about your business</label>
